...
public class Drawings extends javax.swing.JPanel {

    String nome;
    int cont = 0;
    ListaDupla listaDoble = new ListaDupla();

    public Drawings(int cont, ListaDupla listaDoble) {
        initComponents();
        this.setOpaque(true);
    ...
    public void paint(Graphics g) {
        ...
        for (int i = 0; i < cont; i++) {
            ...
            g.drawString(listaDoble.get(i).dado.getNome(), disNome, 60);
